...
var app = (function () {
    ...
    /* src/Welcome.svelte generated by Svelte v3.32.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			p = element("p");
    			p.textContent = "A Simple Way To Solve Sudokus";
    			t5 = space();
    			div2 = element("div");
    			t6 = space();
    			...
    			add_location(div0, file, 6, 4, 162);
    			attr_dev(h1, "class", "svelte-1o0wc5m");
    			add_location(h1, file, 9, 8, 214);
    			add_location(br, file, 10, 8, 256);
    			add_location(p, file, 11, 8, 269);
    			add_location(div1, file, 8, 4, 200);
    			set_style(div2, "flex", "1");
    			add_location(div2, file, 16, 4, 344);
    			attr_dev(button, "class", "is-primary button svelte-1o0wc5m");
    			add_location(button, file, 19, 8, 394);
    			add_location(footer, file, 18, 4, 377);
    			set_style(main, "display", "flex");
    			set_style(main, "flex-direction", "column");
    			set_style(main, "min-height", "100vh");
    			attr_dev(main, "class", "svelte-1o0wc5m");
    ...
    /* src/StockSudoku.svelte generated by Svelte v3.32.1 */
    const file$1 = "src/StockSudoku.svelte";
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$1, 20, 12, 569);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(tr, "class", "svelte-1cp22h7");
    			add_location(tr, file$1, 9, 12, 220);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$1, 25, 24, 771);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td, "class", "svelte-1cp22h7");
    			add_location(td, file$1, 23, 24, 677);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(td, "class", "svelte-1cp22h7");
    			add_location(td, file$1, 14, 24, 455);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(td, "border-right", "solid");
    			attr_dev(td, "class", "svelte-1cp22h7");
    			add_location(td, file$1, 12, 24, 357);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(table, file$1, 6, 0, 140);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/ChooseSize.svelte generated by Svelte v3.32.1 */
    const file$2 = "src/ChooseSize.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h6, file$2, 32, 16, 842);
    			add_location(div, file$2, 31, 12, 803);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Continue";
    			set_style(div0, "height", "10vh");
    			add_location(div0, file$2, 18, 4, 416);
    			attr_dev(h1, "class", "svelte-5t3w6c");
    			add_location(h1, file$2, 21, 8, 468);
    			add_location(div1, file$2, 20, 4, 454);
    			add_location(h6, file$2, 26, 8, 656);
    			attr_dev(input, "type", "number");
    			add_location(input, file$2, 28, 12, 714);
    			add_location(label, file$2, 27, 8, 694);
    			set_style(div2, "flex", "1");
    			set_style(div2, "display", "flex");
    			set_style(div2, "justify-content", "center");
    			set_style(div2, "align-items", "center");
    			set_style(div2, "flex-direction", "column");
    			add_location(div2, file$2, 24, 4, 518);
    			attr_dev(button, "class", "is-primary button svelte-5t3w6c");
    			add_location(button, file$2, 38, 8, 984);
    			add_location(footer, file$2, 37, 4, 967);
    			set_style(main, "display", "flex");
    			set_style(main, "flex-direction", "column");
    			set_style(main, "min-height", "100vh");
    			attr_dev(main, "class", "svelte-5t3w6c");
    			add_location(main, file$2, 16, 0, 339);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Sudoku.svelte generated by Svelte v3.32.1 */

    const file$3 = "src/Sudoku.svelte";
    ...
    /* src/InputSudoku.svelte generated by Svelte v3.32.1 */
    const file$4 = "src/InputSudoku.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "height", "10vh");
    			add_location(div0, file$4, 12, 4, 322);
    			attr_dev(h1, "class", "svelte-5t3w6c");
    			add_location(h1, file$4, 15, 8, 374);
    			add_location(div1, file$4, 14, 4, 360);
    			set_style(div2, "flex", "1");
    			set_style(div2, "display", "flex");
    			set_style(div2, "justify-content", "center");
    			set_style(div2, "align-items", "center");
    			set_style(div2, "flex-direction", "column");
    			add_location(div2, file$4, 18, 4, 433);
    			attr_dev(button0, "class", "is-primary button svelte-5t3w6c");
    			set_style(button0, "margin-right", "20px");
    			add_location(button0, file$4, 23, 8, 628);
    			attr_dev(button1, "class", "is-primary button svelte-5t3w6c");
    			set_style(button1, "margin-left", "20px");
    			add_location(button1, file$4, 24, 8, 810);
    			add_location(footer, file$4, 22, 4, 611);
    			set_style(main, "display", "flex");
    			set_style(main, "flex-direction", "column");
    			set_style(main, "min-height", "100vh");
    			attr_dev(main, "class", "svelte-5t3w6c");
    			add_location(main, file$4, 10, 0, 245);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Solver.svelte generated by Svelte v3.32.1 */

    const { console: console_1 } = globals;
    const file$5 = "src/Solver.svelte";
    ...
    function create_else_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-8j5mb1");
    			add_location(h1, file$5, 56, 12, 1501);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-8j5mb1");
    			add_location(h1, file$5, 54, 12, 1438);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			current = true;
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			footer = element("footer");
    			if_block.c();
    			add_location(footer, file$5, 72, 8, 1984);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			footer = element("footer");
    			if (if_block) if_block.c();
    			add_location(footer, file$5, 65, 8, 1747);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, footer, anchor);
    ...
    function create_else_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "is-primary button svelte-8j5mb1");
    			add_location(button, file$5, 76, 16, 2183);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "is-primary button svelte-8j5mb1");
    			add_location(button, file$5, 74, 16, 2036);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			current = true;
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Start Again";
    			attr_dev(button, "class", "is-primary button svelte-8j5mb1");
    			add_location(button, file$5, 67, 16, 1799);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			current = true;
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block1.c();
    			set_style(div0, "height", "10vh");
    			add_location(div0, file$5, 50, 4, 1359);
    			add_location(div1, file$5, 52, 4, 1397);
    			set_style(div2, "flex", "1");
    			set_style(div2, "display", "flex");
    			set_style(div2, "justify-content", "center");
    			set_style(div2, "align-items", "center");
    			set_style(div2, "flex-direction", "column");
    			add_location(div2, file$5, 60, 4, 1562);
    			set_style(main, "display", "flex");
    			set_style(main, "flex-direction", "column");
    			set_style(main, "min-height", "100vh");
    			attr_dev(main, "class", "svelte-8j5mb1");
    			add_location(main, file$5, 48, 0, 1282);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 42, 2, 1040);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_2$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 38, 2, 911);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 34, 2, 786);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 29, 2, 668);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (if_block) if_block.c();
    			add_location(div, file$6, 27, 0, 623);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
