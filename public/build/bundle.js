...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button1, file$4, 24, 8, 767);
    			set_style(p, "position", "absolute");
    			set_style(p, "right", "5px");
    			set_style(p, "bottom", "1px");
    			add_location(p, file$4, 25, 8, 900);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => onContinue(false);
    ...
    const constraintPropagation = (state, n) => {
        let average = calculateAverage(n * n);
    ...
    const checkColumns = (state, average) => {
        //annoying Ide not realizing difference in code;
        // noinspection DuplicatedCode
        for (let i = 0; i < state.length; i++) {
            let count = 0;
    ...
    function create_else_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 32, 12, 864);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1688j5u");
    			add_location(h1, file$5, 30, 12, 801);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			current = true;
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 50, 16, 1507);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "is-primary button svelte-1688j5u");
    			add_location(button, file$5, 48, 16, 1360);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			current = true;
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Start Again";
    			attr_dev(button, "class", "is-primary button svelte-1688j5u");
    			add_location(button, file$5, 42, 16, 1157);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			current = true;
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p.textContent = "Written By Joseph Glynn";
    			set_style(div0, "height", "10vh");
    			add_location(div0, file$5, 26, 4, 722);
    			add_location(div1, file$5, 28, 4, 760);
    			set_style(div2, "flex", "1");
    			set_style(div2, "display", "flex");
    			set_style(div2, "justify-content", "center");
    			set_style(div2, "align-items", "center");
    			set_style(div2, "flex-direction", "column");
    			add_location(div2, file$5, 36, 4, 925);
    			set_style(p, "position", "absolute");
    			set_style(p, "right", "5px");
    			set_style(p, "bottom", "1px");
    			add_location(p, file$5, 53, 8, 1654);
    			add_location(footer, file$5, 39, 4, 1084);
    			set_style(main, "display", "flex");
    			set_style(main, "flex-direction", "column");
    			set_style(main, "min-height", "100vh");
    			attr_dev(main, "class", "svelte-1688j5u");
    			add_location(main, file$5, 24, 0, 645);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => solvePartOfSudoku(state, n);
    ...
    class Solver extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*changePage*/ ctx[2] === undefined && !("changePage" in props)) {
    			console.warn("<Solver> was created without expected prop 'changePage'");
    		}
    	}
